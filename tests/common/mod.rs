#![allow(dead_code)]
/// debug executable
// pub const EXE_DEBUG: &str = "..//target//debug//kfuz2";
/// release executable
pub const EXE_RELEASE: &str = "..//target//release//kfuz2";
/// `SHA1` hash for validation file
pub const SHA1_UNCOMPRESSED: &str = "e81de24a8d78e58c104dfffbd201da416e49218a";
/// `SHA1` hash for compressed validation file
pub const SHA1_COMPRESSED: &str = "ee5015514aa3f641017606521cce4a2994fbf065";
...
pub const VALIDATION_FILE: &str = "test_files//original_u//BitCore.u";
...
pub const FILE_COMPRESSED: &str = "test_files//original_u//BitCore.u.uz2";
